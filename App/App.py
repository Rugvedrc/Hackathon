...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='rugved9999',db='cv')
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                name = resume_data.get('name', 'there')  # Uses 'there' if name is not found
                st.success(f"Hello {act_name}")
